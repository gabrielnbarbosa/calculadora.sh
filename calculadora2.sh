...
echo "#############################################################"
echo "Criadores: Gabriel Barbosa e Francisco Nilson"
echo "Data: 06-12-2022
echo "Com nossa calculadora você tem acesso as operações bases necessarias para bons cálculos do dia a dia"
echo "#############################################################"
